...
db_file = r"/Users/domin/immerverloren"
...
class BoxRepository:
    ...
    def insert_locker_data(self):
        ...
        for i in range(1, 9):
            ...
            if 1 <= i <= 4:
                c.execute(add_locker, (i, "KECIL", 0,))
            elif i == 5 or i == 6:
                c.execute(add_locker, (i, "SEDANG", 0,))
            else:
                c.execute(add_locker, (i, "BESAR", 0,))
    ...
    def insert_items_data(self):
        ...
        insert_apparels = """
            ...
            """
        c.execute(insert_apparels, ("I-01", "APPARELS",))

        insert_snacks = """
            insert into item values(?, ?)
            """
        c.execute(insert_snacks, ("I-02", "SNACKS",))

        insert_skincare = """
            insert into item values(?, ?)
            """
        c.execute(insert_skincare, ("I-03", "SKINCARE",))

        insert_electronics = """
            insert into item values(?, ?)
            """
        c.execute(insert_electronics, ("I-04", "ELECTRONICS",))
    ...
    def insert_operator_data(self):
        ...
        c.execute(insert_operator, ("OP-01", "Stephen", "op123456",))
    ...
    def register_op(self, op_name, op_id, op_pass):
        ...
        c.execute(add_op, (op_id, op_name, op_pass,))
        self.conn.commit()
    #END#
    ...
    def register(self, id, name, email, password):
        ...
        c.execute(add_user, (id, name, email, password,))
        self.conn.commit()
    #END#
    ...
    def complete_transaction(self, id, locker_id, trans_id, time_out):
        ...
        c.execute(update_transaction, (time_out, trans_id,))
        #END#
        ...
        c.execute(update_last_pickup, (time_out, id,))
        #END#
    ...
    def store_package_update(self, trans_id, id, item_type, item_size, locker_id, time_in, verification):
        c = self.conn.cursor()
        ...
        """
        c.execute(add_transaction, (trans_id, id, time_in,))
        #END#
        ...
        """
        c.execute(add_transaction_detail, (trans_id, locker_id, search_item_id, item_size, verification,))
        #END#
    ...
    def search_trans_detail_by_locker_id(self, locker_id, trans_id):
        ...
        c.execute(search_trans_detail, (locker_id, trans_id,))
        rows = c.fetchall()
